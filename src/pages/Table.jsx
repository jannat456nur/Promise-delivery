...
export default function Table() {
  ...
  return (
    <div className="px-4 pt-10 sm:px-6 lg:px-8">
      ...
      <div className="bg-white px-6 py-4 shadow-sm rounded-md flex justify-between">
        <h1 className="text-start items-center pt-6 font-semibold leading-6 text-gray-500 text-lg">
          All Invoices
        </h1>
        <div className="mt-4">
          <p className="text-gray-500 pb-2">Search</p>
          <input
            type="text"
            placeholder="Search..."
            value={searchQuery}
            onChange={(e) => setSearchQuery(e.target.value)}
            className="w-full rounded-md border border-gray-300 px-3 py-2 text-center text-sm text-gray-900 shadow-sm"
          />
        </div>
      </div>
            ...
            <table className="min-w-full border-separate border-spacing-0">
              <thead>
                <tr>
                  <th
                    scope="col"
                    className="sticky top-0 z-10 border-b border-gray-300 bg-gray-100 py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-6 lg:pl-8"
                  >
                    Date
                  </th>
                  <th
                    scope="col"
                    className="sticky top-0 z-10 border-b border-gray-300 bg-gray-100 px-3 py-3.5 text-left text-sm font-semibold text-gray-900"
                  >
                    Payment Id
                  </th>
                  <th
                  ...
                  <th
                    scope="col"
                    className="sticky top-0 z-10 border-b border-gray-300 bg-gray-100 py-3.5 pl-3 pr-4 sm:pr-6 lg:pr-8"
                  >
                    Actions
                  </th>
                </tr>
